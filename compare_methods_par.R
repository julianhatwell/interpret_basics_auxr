...
for (rnr in 1:results_nrows) {
            ...
            write.csv(data.frame(dataset_name = rep(datasetnames[i], n_test)
                                 ...
                                 , true_class = as.numeric(ds_container$y_test[1:n_test]) - 1
                                 , true_class_label = as.character(ds_container$y_test[1:n_test]) # conform with Python zero base
                                 , pred_class = forest_label[1:n_test] - 1 # conform with Python zero base
