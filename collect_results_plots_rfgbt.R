  ...
  myPal1 <- c(reds[2], ongs[2], grns[2], blus[2], prps[2], grys[2])
  myPal2 <- myPal1
  myPal2 <- paste(myPal2, c(rep("55", 3), "", rep("55", 2)), sep = "")
  myAlph1 <- c(rep(0.7, 3), 1, rep(0.7, 2))
  myAlphFixed <- c(rep(0.5, 27), rep(1.0, 9), rep(0.5, 18))
...
get_main_boxplot(wxcoverage.tt.
                 , sc_y = scale_y_continuous(limits = c(0.0, 0.75)))
